...
export default function MultiPageForm() {
	...
	const [active, setActive] = useState("form2");
	...
	return (
		<div>
			...
			<sgds-template-grid>
				<sgds-content-area>
					<sgds-breadcrumb-area></sgds-breadcrumb-area>
					...
					<div className="sgds stepper">
						<div className="stepper-item is-active">
						...
						{[2, 3, 4, 5].map((step) => (
							<div key={step} className={`stepper-item step-${step}`}>
					...
					<div className="d-flex justify-content-end">
						<button
							...
							onClick={() => {
								...
								setActive("form2.2");
								navigate("/form2.2");
								console.log("After:", active); // Note: This won't update immediately due to React's async state updates
							}}
						>
							Next →
						</button>
